...
HELP_MESSAGE = """🌟 Welcome to our interactive chat! Here are some commands to navigate:

⚪ /retry – Want to see another response? Use this!
⚪ /new – Start a fresh conversation.
⚪ /mode – Select your preferred chat mode.
⚪ /settings – Customize your chat experience.
⚪ /balance – Check your balance.
⚪ /help – Need assistance? Get help here.

Dive into the world of creativity with <b>👩‍🎨 Artist</b> /mode.
Bring the bot into group chats: /help_group_chat.
Express yourself with Voice Messages instead of text. Feel free to explore and enjoy our chat experience! 🚀
"""

HELP_GROUP_CHAT_MESSAGE = """🌟 Welcome to our unique chat experience!

Want to enhance your group chats with some fun and assistance? Here's how:

Instructions (check out the video below):

Add the bot to your group chat.
Grant it admin privileges to view messages (other rights can be restricted).
You're awesome for making your chat even better!
To get a response from the bot in your chat, simply @ <b>mention</b> it or <b>reply</b> to its message.
